# Claude Code Cost website

The landing page and docs for Claude Code Cost, published at https://nikiforovall.blog/claude-code-cost/. Built with Astro and Starlight.
...
- `src/kit/` and `src/components/` are the design kit: layout, themes, `Shot`, `Lightbox`, `Keys`. The same kit is in the Kanban, Marketplace and Memory sites. Keep the copies the same.
